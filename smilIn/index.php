		...
		<video autoplay height="100%" width="100%" class="blurred"></video>
          ...
          <div class="container-fluid">
          	<div class="toggleContainer" >
	            ...
	            <br>
	            <p class="lead">SmilIn is the future of web security. Take security in your own hands. SmilIn is a WebAPI that allows users to log in to their websites using a spoken string and face recognition. The ultimate login experience is here.</p>
	            
	              <a href="#" class="doToggle btn btn-lg btn-default frontBut" style="width: 100px;">Register</a>
	              <a href="login.php" class="btn btn-lg btn-default frontBut" style="width: 100px;">Log In</a>
