					...
					<div class="col-xs-12 col-md-4 col-md-offset-4">
						...
						<center>
							<form action="loginFunc.php" method="post">
								<input class="recorded frontInput" type="text" name="username" style="" placeholder="Tap To Record/Stop2" readonly x-webkit-speech>	
								<div class="clearfix" style="height: 20px;"></div>
								<input style="display:none;" class="frontInput" id="number" type="number" name="pin" style="" placeholder="Your Backup Pin">	
								...
								<input data-role="none" type="submit" name="register" value="Login To SmilIn" class="btn btn-lg btn-default frontBut" style="background:transparent; margin-top: 20px; color: white;">		
